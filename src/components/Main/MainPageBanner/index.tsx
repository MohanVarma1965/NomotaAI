...
const MainPageBanner: React.FC = () => {
  return (
    <div className=" main-banner-container py-16 mx-auto text-gray-900 md:px-4 max-md:p-8 md:container md:flex md:items-center md:justify-between">
      <div className="md:flex-1 md:pr-12">
        ...
        <div className="mb-8 flex justify-left ">
          ...
          >
            ...
            <span>Follow us for the latest news</span>
          </a>
        </div>
        <div className="mb-8 flex justify-left">
          <a
      ...
      <div className="main-banner-image flex-1 lg:block">
        <img src="/homepageEdited.png" alt="Crypto" className="w-full h-auto" />
      </div>
    </div>
  );
};
