      ...
      <div className="md:flex-1 md:pr-12">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-3">
            <a
              href="#"
              className="flex items-center justify-center px-6 py-3 transition-colors duration-300 border border-gray-600 rounded-lg hover:border-green-500 hover:bg-green-500 hover:bg-opacity-25"
            >
              <span>🐍 &nbsp;</span>
              <span>KuCoin</span>
            </a>
            <a
              href="#"
              className="flex items-center justify-center px-6 py-3 transition-colors duration-300 border border-gray-600 rounded-lg hover:border-pink-500 hover:bg-pink-500 hover:bg-opacity-25"
            >
              <span>🦄 &nbsp;</span>
              <span>Uniswap</span>
            </a>
            <a
              href="#"
              className="flex items-center justify-center px-6 py-3 transition-colors duration-300 border border-gray-600 rounded-lg hover:border-yellow-400 hover:bg-yellow-400 hover:bg-opacity-25"
            >
              <span>🥞 &nbsp;</span>
